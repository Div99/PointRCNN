...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("Generate pseudo-LiDAR ground planes")
   ...
   # parser.add_argument('--planes_dir', default='KITTI/object/training/velodyne_planes')
    ...
    calib_dir = os.path.join(args.point_style, args.split, 'calib')
    lidar_dir = os.path.join(args.point_style, args.split, 'velodyne')
    planes_dir = os.path.join(args.point_style, args.split, 'planes')

    extract_ransac(calib_dir, lidar_dir, planes_dir)
